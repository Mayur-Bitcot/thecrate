...
(function (b, h, g) {
  function c(a, d) {
    ...
    void 0 === this.options.zIndex &&
      ...
      "auto" == this.zIndex && (this.zIndex = 100));
  ...
  var q = -1 != navigator.userAgent.indexOf("MSIE 7.0"),
    ...
    k = (h.StickScope = { Parent: 0, Document: 1 }),
    e = { None: 0, Fixed: 1, Absolute: 2 },
    t = !1;
  ...
  c.prototype.bound = function () {
    ...
    this.parent = {
      border: { bottom: parseInt(a.parent().css("border-bottom-width")) || 0 },
    };
  };
  ...
  c.prototype.updateScroll = function (a) {
    0 != this.offsetHeight &&
      ((this.offsetY = Math.max(
        this.offsetY + a - this.lastY,
        -(this.options.top + this.offsetHeight)
      )),
  ...
  c.prototype.isActive = function () {
    return (
      (void 0 === this.options.screenMinWidth ||
        l >= this.options.screenMinWidth) &&
      (void 0 === this.options.screenMaxWidth ||
        l <= this.options.screenMaxWidth) &&
    ...
    if (this.isActive())
      switch (this.stick) {
        case e.Fixed:
          ...
          0 <= d
            ? this.reset()
            : this.options.scope == k.Parent
            ? ((a = b.parent()[0].getBoundingClientRect()),
              a.bottom + this.baseParentOffset + this.offsetHeight <=
              b.outerHeight(!1) + this.basePadding
        ...
        case e.Absolute:
          ...
          0 <= d
            ...
            : ((a = b.parent()[0].getBoundingClientRect()),
              a.bottom + this.baseParentOffset + this.offsetHeight >
                b.outerHeight(!1) + this.basePadding &&
                this.setFixed(f + r, a.bottom, -this.offsetHeight));
          break;
        default:
          (a = b[0].getBoundingClientRect()),
            (d = a.top - this.baseTop),
            0 <= d ||
              ((d = b.parent()[0].getBoundingClientRect()),
              c.height(b.height()),
              c.show(),
              (f = a.left - this.margin.left),
              this.options.scope == k.Document
                ? this.setFixed(f, a.bottom, 0)
                : d.bottom + this.baseParentOffset <=
                  b.outerHeight(!1) + this.basePadding
                ? this.setAbsolute(this.element.position().left)
                : this.setFixed(f + r, a.bottom, 0),
  ...
  c.prototype.resize = function () {
    ...
    if (this.stick != e.None) {
      ...
      b.height(a.height());
      this.stick == e.Fixed &&
        ((b = this.spacer[0].getBoundingClientRect().left - this.margin.left),
        a.css("left", b + "px"));
    }
    this.locate();
  };
  ...
  b.fn.stickit = function (a, d) {
    "string" == typeof a
      ...
      : (t ||
          ...
          n(),
          b(g).ready(function () {
            b(h).bind("resize", n).bind("scroll", m);
            b(g.body).on(
          ...
          u &&
            new MutationObserver(m).observe(g, {
              attributes: !0,
              childList: !0,
              characterData: !0,
              subtree: !0,
